...
void Henkilo::operator=(Henkilo& toinenHenkilo)
{
	etunimi = toinenHenkilo.annaEtunimi();
	sukunimi = toinenHenkilo.annaSukunimi();
	osoite = toinenHenkilo.annaOsoite();
	puhelinnumero = toinenHenkilo.annaPuhelinnumero();
